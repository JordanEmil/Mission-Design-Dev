#!/usr/bin/env python3
"""
RAG Query Pipeline using LlamaIndex with ChromaDB Cloud support
...
class SpaceMissionQueryEngine:
    ...
    def __init__(
        ...
        Args:
            use_cloud: Whether to use ChromaDB cloud (True) or local (False)
            chroma_persist_dir: Directory where ChromaDB is persisted (for local)
    ...
    def _setup_chromadb(self):
        ...
        if self.use_cloud:
            ...
            self.chroma_client = chromadb.CloudClient(
                api_key='ck-HuA5HGfVa4XUtMFikAhrZ5Z9GoDKRaB2Z3iLpcnCKPEX',
                tenant='d3306e9d-1515-4428-b570-52efbe014a7b',
                database='Space Mission Design Assistant'
            )
        else:
            # Use local ChromaDB
            logger.info(f"Connecting to local ChromaDB at {self.chroma_persist_dir}...")
    ...
    def query(
        ...
        result = {
            ...
            'metadata': {
                ...
                'source': 'chromadb_cloud' if self.use_cloud else 'chromadb_local'
            }
        }
    ...
    def get_engine_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'storage': 'chromadb_cloud' if self.use_cloud else 'chromadb_local'
        }
...
def main():
    ...
    # Initialize query engine with cloud by default
    print("Initializing query engine with ChromaDB Cloud...")
    query_engine = SpaceMissionQueryEngine(
        use_cloud=True,  # Use cloud by default
        top_k=5,
    ...
    print("✓ Query pipeline is ready to use")
